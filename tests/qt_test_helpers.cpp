...
QStringList qmlSourceFiles() {
  return {
      ...
      QStringLiteral("features/rightPanel/LayersSection.qml"),
      QStringLiteral("features/rightPanel/NavigationSection.qml"),
      ...
      QStringLiteral("features/rightPanel/TextEffectsSection.qml"),
