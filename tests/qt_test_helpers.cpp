...
QString qmlSource()
{
    return readQmlFile(QStringLiteral("Main.qml")) + QLatin1Char('\n')
        ...
        + readQmlFile(QStringLiteral("PathHandleInteractionState.qml")) + QLatin1Char('\n')
        + readQmlFile(QStringLiteral("PerspectiveGeometry.qml")) + QLatin1Char('\n')
        + readQmlFile(QStringLiteral("PerspectiveInteractionState.qml")) + QLatin1Char('\n')
