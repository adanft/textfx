...
QString readQmlFile(const QString &name) {
  ...
  const QStringList candidates{
      ...
      QStringLiteral("features/rightPanel/pageEffects/") + name,
...
QStringList qmlSourceFiles() {
  return {
      ...
      QStringLiteral("features/rightPanel/pageEffects/PageEffectsSection.qml"),
      ...
      QStringLiteral("features/canvas/text/TextBoxDelegateUi.qml"),
