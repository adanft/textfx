...
class EditorController final : public QObject {
    ...
    Q_PROPERTY(bool rawVisible READ rawVisible WRITE setRawVisible NOTIFY stateChanged)
    ...
    Q_PROPERTY(int selectedPresetIndex READ selectedPresetIndex NOTIFY documentChanged)
...
public:
    ...
    Q_INVOKABLE void setPerspectiveHandle(const QString& corner, double x, double y);
