...
bool TextBoxSelectionService::duplicateSelected(std::vector<TextBox> &boxes,
                                                int &selectedIndex) {
...
bool TextBoxSelectionService::deleteSelected(std::vector<TextBox> &boxes,
                                             int &selectedIndex) {
